...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'glass': '0 0 10px 0 rgba(255, 255, 255, 0.2)',
				'glass-hover': '0 0 15px 0 rgba(255, 255, 255, 0.3)',
				'neo': '10px 10px 20px rgba(17, 17, 26, 0.1), -10px -10px 20px rgba(255, 255, 255, 0.5)',
